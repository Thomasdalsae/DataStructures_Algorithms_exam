...
int main(int argc, char* argv[])
{
    ...
    Hash_Table<string>* Table = new Hash_Table<string>;
    ...
    // Person<string> Jacob = {"Person1", "Jacob", 56};
    ...
    Table->print_table();
    Person<int> tmp = Table->hash_table_lookup("Kate");
